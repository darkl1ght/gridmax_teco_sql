...
CREATE OR ALTER FUNCTION [GADS].[PLANT_METER_READINGS_FN]
    (
            ...
            (
                ...
                VALUETYPE
                    ...
                    SELECT
                        ...
                        CASE
                            WHEN [ObjectType] = 'Generator'
                                THEN 'g'
                            WHEN [ObjectType] = 'Station Service'
                                THEN 's'
                            WHEN [ObjectType] = 'Reserve'
                                THEN 'r'
                        END                                       AS [VALUETYPE]
                    FROM
