-- TO run
-- snowsql -c <CONN> -f prod_rollin.sql
--
!spool prod_rollin.log
USE ROLE AGSFETLF;
...
create TABLE IF NOT EXISTS MANUAL_GADS_METADATA (
...
create TABLE IF NOT EXISTS MANUAL_GADS_DATA (
    ASSET_TYPE_CD VARCHAR,
    ASSET_CD VARCHAR,
...
BEGIN
    -- Example: CALL GET_STALE_DUPE_RECORDS_QUERY('SF_DB_DAP_RAW_PRD','GRIDMAX','DAILY_GEN');
...
CREATE PROCEDURE IF NOT EXISTS GADS_ALL_DATA_CDC()
RETURNS VARCHAR
LANGUAGE JAVASCRIPT
EXECUTE AS CALLER
AS
...
CREATE TABLE IF NOT EXISTS GADS_SLF_CONSUMPTION_QUALITY (
	AREA VARCHAR,
...
RETURNS VARIANT
API_INTEGRATION = INT_API_AZURE_DAP_PROD_GADS
HEADERS = ('Content-Type' = 'application/json')
AS 'https://apim-teco-ahubgads-prod.azure-api.net/azfun-teco-ahubgads-eastus-prod/allegro';

CREATE PROCEDURE IF NOT EXISTS GADS_DATA_CDC(p_function_name STRING, p_start_date STRING, p_end_date STRING)
RETURNS STRING
LANGUAGE JAVASCRIPT
EXECUTE AS CALLER
AS
    ...
    try {
        ...
        switch (p_function_name) {
            case "SlfConsumptionQuality":
                v_table_name = "ALLEGRO.GADS_SLF_CONSUMPTION_QUALITY";
...
create TABLE IF NOT EXISTS DAILY_GEN (
	YEAR NUMBER(38,0),
	MONTH NUMBER(38,0),
...
API_INTEGRATION = INT_API_AZURE_DAP_PROD_GADS
HEADERS = ('Content-Type' = 'application/json')
AS 'https://apim-teco-ahubgads-prod.azure-api.net/azfun-teco-ahubgads-eastus-prod/gridmax';

CREATE PROCEDURE IF NOT EXISTS DAILY_GEN_CDC(p_function_name STRING, p_start_date STRING, p_end_date STRING)
RETURNS STRING
LANGUAGE JAVASCRIPT
EXECUTE AS CALLER
AS
$$
    ...
    try {
        ...
        switch (p_function_name) {
            case "ALL":
                v_table_name = "GRIDMAX.DAILY_GEN";
...
create TABLE IF NOT EXISTS EVENT_HOURS_SUMMARY (
	LOCATION VARCHAR,
...
create TABLE IF NOT EXISTS FLEET_RAM_KPIS (
	LOCATION VARCHAR,
	PERIOD VARCHAR,
	WEAF VARCHAR,
	WEMOF VARCHAR,
...
create TABLE IF NOT EXISTS GEN_FUEL_PERF (
	LOCATION VARCHAR,
	REPORTING_LEVEL VARCHAR,
    PERIOD VARCHAR,
...
create TABLE IF NOT EXISTS GEN_PERF_INCENTIVES (
	LOCATION VARCHAR,
	REPORTING_LEVEL VARCHAR,
	PERIOD VARCHAR,
	NET_EQUIV_AVAIL_FACTOR VARCHAR,
...
create TABLE IF NOT EXISTS NET_FACTORS_RATES (
	LOCATION VARCHAR,
	REPORTING_LEVEL VARCHAR,
	PERIOD VARCHAR,
	NCF VARCHAR,
...
API_INTEGRATION = INT_API_AZURE_DAP_PROD_GADS
HEADERS = ('Content-Type' = 'application/json')
AS 'https://apim-teco-ahubgads-prod.azure-api.net/azfun-teco-ahubgads-eastus-prod/orap';

CREATE PROCEDURE IF NOT EXISTS ORAP_KPI_CDC(p_function_name STRING, p_start_date STRING, p_end_date STRING)
RETURNS STRING
LANGUAGE JAVASCRIPT
EXECUTE AS CALLER
AS
$$
    ...
    try {
        ...
        switch (p_function_name) {
            case "GetGenFuelPerf":
                v_table_name = "ORAP.GEN_FUEL_PERF";
            ...
            case "GetGenPerfIncent":
                v_table_name = "ORAP.GEN_PERF_INCENTIVES";
            ...
            case "GetNetFactorsRates":
                v_table_name = "ORAP.NET_FACTORS_RATES";
...
create TABLE IF NOT EXISTS GADS_HOUR (
    TAGID NUMBER(38,0),
...
API_INTEGRATION = INT_API_AZURE_DAP_PROD_GADS
HEADERS = ('Content-Type' = 'application/json')
AS 'https://apim-teco-ahubgads-prod.azure-api.net/azfun-teco-ahubgads-eastus-prod/pgsdss';
...
create TABLE IF NOT EXISTS GADS_METADATA (
...
create TABLE IF NOT EXISTS GADS_DATA (
	ASSET_CD VARCHAR,
	ASSET_TYPE_CD VARCHAR,
    METRIC_CD VARCHAR,
	TIME TIMESTAMP_NTZ(9),
...
API_INTEGRATION = INT_API_AZURE_DAP_PROD_GADS
HEADERS = ('Content-Type' = 'application/json')
AS 'https://apim-teco-ahubgads-prod.azure-api.net/azfun-teco-ahubgads-eastus-prod/pi';
...
$$    
    ...
    try {
        ...
        rs = snowflake.execute({sqlText: "SELECT * FROM PI.GADS_METADATA WHERE IS_ACTIVE = 1"});
